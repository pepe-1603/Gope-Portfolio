...
export interface ActiveModal {
  ...
  show: boolean
  _resolver: ((value: any) => void) | null
  _actionResult: any
}

export interface ModalResult {
  id: number
  action: 'confirm' | 'cancel' | 'close' | 'duplicate' | 'programmatic_close'
  // | 'connection_lost_preempt'
  // | 'connection_restored_preempt'
  // | 'backend_down_preempt'
  // | 'backend_up_preempt'
  payload?: any
}
